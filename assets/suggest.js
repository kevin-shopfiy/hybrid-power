(function( $ ) {
   ...
   function RandomSalesPopUp() {
      ...
      var data_url = $('#nt__suggest').attr("data-url")+NtHandleArr[random],img = NtimgArr[random];
     if (img !== null) {
          var img_url = img.replace(".jpg?v=", "_90x.jpg?v=").replace(".png?v=", "_90x.png?v=").replace(".gif?v=", "_90x.gif?v="),
          img_url2 = img.replace(".jpg?v=", "_90x@2x.jpg?v=").replace(".png?v=", "_90x@2x.png?v=").replace(".gif?v=", "_90x@2x.gif?v=");
     } else {
      var img_url = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",
          img_url2 = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";
     }
   ...
   function SequentialSalesPopUp() {
      ...
      var data_url = $('#nt__suggest').attr("data-url")+NtHandleArr[random-1],img = NtimgArr[random-1];
     if (img !== null) {
          var img_url = img.replace(".jpg?v=", "_90x.jpg?v=").replace(".png?v=", "_90x.png?v=").replace(".gif?v=", "_90x.gif?v="),
          img_url2 = img.replace(".jpg?v=", "_90x@2x.jpg?v=").replace(".png?v=", "_90x@2x.png?v=").replace(".gif?v=", "_90x@2x.gif?v=");
     } else {
