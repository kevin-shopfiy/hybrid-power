...
//redirect url from https://hybridps.ca/collections to  https://hybridps.ca
//$(window).on('load',function () {
  var url  = window.location.href;
  console.log(url);
  if(url == 'https://hybridps.ca/collections'){
    window.location.replace('https://hybridps.ca');
    //console.log("yes");
  }
  if(url == 'https://hybridps.ca/collections/'){
    //console.log("yes");
...
// new product template documentation button js
